                ...
                <div key={message.id} className="flex justify-start">
                  <div
                    ...
                    style={{
                      ...
                      border: isScarcityAlert ? '2px solid #F59E0B' : '1px solid #15803d',
                    ...
                    <p
                      ...
                      dangerouslySetInnerHTML={{
                        __html: DOMPurify.sanitize(message.content.replace(
                          /\[([^\]]+)\]\(([^\)]+)\)/g,
                          '<a href="$2" target="_blank" rel="noopener noreferrer" style="color: #15803d; text-decoration: underline; font-weight: bold;">$1</a>'
                        ))
                      }}
                    />
                  </div>
                ...
                <div key={message.id} className="my-4">
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="text-[11px] font-medium" style={{ color: '#86efac', opacity: 0.9 }}>
                    ...
                    <div className="px-6 pt-8 pb-6 text-center">
                      ...
                      <div className="mt-5 flex flex-col items-center gap-1.5">
                        <span className="inline-block px-4 py-1.5 rounded-full text-xs font-bold tracking-wide" style={{ backgroundColor: '#15803d', color: '#ffffff' }}>
                    ...
                    {(() => {
                      ...
                      const scoreColor = score >= 80 ? '#15803d' : score >= 55 ? '#b45309' : '#dc2626'
                      const scoreLabel = score >= 80 ? 'Hot Lead' : score >= 55 ? 'Warm Lead' : 'Cold Lead'
                      return (
                        <div className="px-6 py-4" style={{ backgroundColor: '#f0fdf4', borderTop: '1px solid #dcfce7', borderBottom: '1px solid #dcfce7' }}>
                          <div className="flex items-center justify-between mb-2">
                            <span className="text-[10px] uppercase tracking-widest font-semibold" style={{ color: '#6b7280' }}>Lead Quality Score</span>
                            <span className="text-sm font-bold" style={{ color: scoreColor }}>{score}/100 — {scoreLabel}</span>
                          </div>
                          <div className="w-full h-2 rounded-full overflow-hidden" style={{ backgroundColor: '#dcfce7' }}>
                    ...
                    {/* Divider */}
                    <div className="mx-6" style={{ borderTop: '1px solid rgba(0,0,0,0.08)' }} />
        ...
        <div className="mx-auto max-w-4xl">
          ...
          {state.certaintyLevel > 0 && (
            <div className="mt-3 flex items-center gap-2">
              <div className="flex-1 h-1 rounded-full overflow-hidden" style={{ backgroundColor: '#166534' }}>
                <div
